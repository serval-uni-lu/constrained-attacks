...
class CMAPGD(Attack):
    r"""
    Based on APGD in the paper 'Reliable evaluation of adversarial robustness with an ensemble of diverse parameter-free attacks'
    [https://arxiv.org/abs/2003.01690]
    [https://github.com/fra31/auto-attack]

    And improved with momentum process proposed by MI-FGSM in the paper 'Boosting Adversarial Attacks with Momentum'
