...
DEVICES=-1
BATCH_SIZE=1024
ATTACK="apgd3-nrep+apgd3-nini+apgd3-nran+apgd3-nada"
FILTER_CLASS=1
DEVICE="cpu"
SEED="${SEED:-0}"
...
do
    ...
    for DATASET in lcld_v2_iid wids url ctu_13_neris
    do
