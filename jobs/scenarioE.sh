...
do
    ...
    do
        ...
        do
            for SCENARIO in "--no-constraints_access --project_name scenario_E2v10"
            do
                list_target_path=""
                for model in "${MODEL_TARGET[@]}"; do
